...
const Footer = () => {
  return (
    <Element name="contact">
      <section id="contact" className=" bg-DBlue py-10 ">
        <div className=" lg:w-[85%] mx-auto flex flex-col lg:flex-row justify-between items-start">
          <div className=" flex flex-col gap-3 lg:flex-row lg:gap-32 w-full">
            <div className="flex flex-col items-center gap-5 lg:items-start">
              ...
              <div className=" flex flex-row items-center gap-3 lg:mt-auto">
                <a href="" className="group">
                  ...
                  >
                    <path
                      className=" group-hover:fill-[#3b5998] duration-150"
                      fill="#FFF"
                ...
                <a href="#" className="group">
                  ...
                  >
                    <path
                      className=" group-hover:fill-[#c4302b] duration-150"
                      fill="#FFF"
                ...
                <a href="#" className="group">
                  ...
                  >
                    <path
                      className="group-hover:fill-[#00acee] duration-150"
                      fill="#FFF"
                ...
                <a href="#" className="group">
                  ...
                  >
                    <path
                      className="group-hover:fill-[#c8232c] duration-150"
                      fill="#FFF"
                ...
                <a href="#" className="group">
                  ...
                  >
                    <path
                      className=" group-hover:fill-[#fa461e] duration-150"
                      fill="#FFF"
            ...
            <nav className="text-LGray flex flex-col gap-3 items-center lg:items-start mt-3 lg:mt-0">
              <HashLink
                to={"#services"}
                smooth
                className=" hover:text-LGreen duration-150"
              >
                About Us
              </HashLink>
              <HashLink
            ...
            <nav className="text-LGray flex flex-col gap-3 items-center lg:items-start">
              <HashLink to={""} className=" hover:text-LGreen duration-150">
                Careers
              </HashLink>
              <HashLink to={""} className=" hover:text-LGreen duration-150">
                Support
          ...
          <div className=" w-full text-white flex flex-col items-center mt-7 gap-3 lg:gap-5 lg:items-end">
            <GButton />
